<?php 
    ...
    $toEmail = 'ihopenone@gmail.com'; // Recipient email 
    $from = $_POST['email']; // Sender email 
    $fromName = $_POST['f_name']; // Sender name 


    $attachmentUploadDir = "assets/uploads/"; 
    ...
    if(isset($_POST['submit'])){ 
        ...
        if(empty($valErr)){ 
            ...
            if($uploadStatus == 1){ 
                // Email subject 
                $emailSubject = 'Contact Request Submitted by '.$f_name.$l_name; 
                 
                // Email message  
                $htmlContent = '<h2>Contact Request Submitted</h2> 
                    <p><b>Name:</b> '.$f_name.' '.$l_name.'</p> 
                    <p><b>Email:</b> '.$email.'</p> 
                    <p><b>Subject:</b> Career Form Submission </p> 
