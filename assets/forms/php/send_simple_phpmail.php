...
<head>
	...
	<meta name="description" content="PECPL Tech career form submission">
...
if (!$errors) {	
	...
	$message .= "--\n";
	if (file_exists($file)) {
		$message .= "https://pecpl.tech/assets/forms/php/". $file;
	} else {
	...
	$userheaders = "From: admin@pecpl.tech";
	...
	echo '<g fill="none" stroke="#ad3a6e" stroke-width="2">';
	...
	echo '<a class="animated-link" href="../../vendor/careers-copy.html">Go Back</small>';
	echo '</div>';	
}
